sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("S0003072839/testStory/app", ".html");
		...
		return Opa5.extend("S0003072839.testStory.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["S0003072839/testStory/localService/mockserver"], function (mockserver) {
